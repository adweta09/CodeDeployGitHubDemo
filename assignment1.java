...
//        double assignmentOneMarks,assignmentTwomarks,projectMarks,totalMarks;
            ...
            switch (choice) {
                ...
                case 2:
                        if(count == 0)
                        {
                            ...
                            for (int i = 0; i < n; i++) {
                                System.out.printf("\n Student Name: %s \t Student ID: %s \t AssignmentOne Marks: %f \t AssignmentTwo Marks: %f \t Project Marks: %f \t Total MarksL %f", s[i].getStudentName(), s[i].getStudentID(), s[i].getAssignmentOneMarks(), s[i].getAssignmentTwoMarks(), s[i].getProjectMarks(), total[i]);
                            }
                        }
                            break;
